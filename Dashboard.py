...
def fileSearch():
	...
	fileEntry=[]
	for file in os.listdir("C:/Users/thummala madhukar/OneDrive/Desktop/IV_1_project/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/SampleGestures"):
...
def capture_images(self,cam,saveimg,mask):
	...
	cam.release()
	cv2.destroyAllWindows()
	if not os.path.exists('.C:/Users/thummala madhukar/OneDrive/Desktop/IV_1_project/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/SampleGestures'):
		os.mkdir('C:/Users/thummala madhukar/OneDrive/Desktop/IV_1_project/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/SampleGestures')

	gesname=saveimg[-1]
	if(len(gesname)>=1):
		img_name = "C:/Users/thummala madhukar/OneDrive/Desktop/IV_1_project/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/SampleGestures/"+"{}.png".format(str(gesname))
...
def predictor():
	...
	for i in range(len(fileEntry)):
		image_to_compare = cv2.imread("C:/Users/thummala madhukar/OneDrive/Desktop/IV_1_project/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/SampleGestures/"+fileEntry[i])
...
class Dashboard(QtWidgets.QMainWindow):
	def __init__(self):
		...
		cap = cv2.VideoCapture('gesture_images.mp4')
		...
		cv2.destroyAllWindows()
		self.setWindowIcon(QtGui.QIcon('C:/Users/thummala madhukar/OneDrive/Desktop/IV_1_project/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/icons/windowLogo.png'))
		self.title = 'Sign language Recognition'
		uic.loadUi('C:/Users/thummala madhukar/OneDrive/Desktop/IV_1_project/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/UI_Files/dash.ui', self)
		...
		movie = QtGui.QMovie("C:/Users/thummala madhukar/OneDrive/Desktop/IV_1_project/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/icons/dashAnimation.gif")
	...
	def createGest(self):
		...
		try:
			...
			pass
		gesname=""
		uic.loadUi('C:/Users/thummala madhukar/OneDrive/Desktop/IV_1_project/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/UI_Files/create_gest.ui', self)
		self.setWindowTitle(self.title)
		self.create.clicked.connect(self.createGest)
		self.exp2.clicked.connect(self.exportFile)
		...
		if os.path.exists("C:/Users/thummala madhukar/OneDrive/Desktop/IV_1_project/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/SampleGestures/"+str(gesname)+".png"):
	...
	def exportFile(self):
		...
		try:
			...
			pass
		uic.loadUi('C:/Users/thummala madhukar/OneDrive/Desktop/IV_1_project/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/UI_Files/export.ui', self)
		self.setWindowTitle(self.title)
		self.create.clicked.connect(self.createGest)
		self.exp2.clicked.connect(self.exportFile)
		self.scan_sen.clicked.connect(self.scanSent)
	...
	def scanSent(self):
		...
		try:
			...
			pass
		uic.loadUi('C:/Users/thummala madhukar/OneDrive/Desktop/IV_1_project/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/UI_Files/scan_sent.ui', self)
		self.setWindowTitle(self.title)
		self.create.clicked.connect(self.createGest)
		self.exp2.clicked.connect(self.exportFile)
		if(self.scan_sen.clicked.connect(self.scanSent)):
	...
	def scanSingle(self):
		...
		try:
			...
			pass
		uic.loadUi('C:/Users/thummala madhukar/OneDrive/Desktop/IV_1_project/Sign-Language-Recognition-Using-Hand-Gestures-Keras-PyQT5-OpenCV-master/Source Code/UI_Files/scan_single.ui', self)
		self.setWindowTitle(self.title)
		self.create.clicked.connect(self.createGest)
		self.exp2.clicked.connect(self.exportFile)
		self.scan_sen.clicked.connect(self.scanSent)
